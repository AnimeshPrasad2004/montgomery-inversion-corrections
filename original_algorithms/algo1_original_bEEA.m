% =========================================================
% Algorithm 1: Original Constant-Time Binary Extended
% Euclidean Algorithm (bEEA) from Sava & Ko [1]
%
% Reference:
...
function r = algo1_original_bEEA(p, a, M, displayLog)
    u = p;  v = a;
    r = 0;  s = M;
    k = 0;
    n   = ceil(log2(p));
